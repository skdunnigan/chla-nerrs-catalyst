...
```{r isco, dpi = 120}
interact_reserve_isco_fxn("LKS")
```

## Tank Samples

```{r tank, dpi = 120}
interact_reserve_tank_fxn("LKS")
```
...
interact_reserve_interf_fxn("LKS", param = fdom)
```

## Turbidity

```{r turb-interf, dpi = 120}
interact_reserve_interf_fxn("LKS", param = turbidity)
```

## Temperature

```{r temp-interf, dpi = 120}
interact_reserve_interf_fxn("LKS", param = temperature)
```
