...
sum_table_final  %>% 
  kbl(align = "c", caption = 'Summary information for all parameters (Min-Max (Mean \U00B1 Standard Dev)) from each participating reserve for both tank and ISCO experiments. This table contains data that has not had QAQC flagged data removed.') %>% 
