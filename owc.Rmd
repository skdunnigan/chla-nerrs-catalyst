...
```{r isco, dpi = 120}
interact_reserve_isco_fxn("OWC")
```

## Tank Samples

```{r tank, dpi = 120}
interact_reserve_tank_fxn("OWC")
```
...
interact_reserve_interf_fxn("OWC", param = fdom)
```

## Turbidity

```{r turb-interf, dpi = 120}
interact_reserve_interf_fxn("OWC", param = turbidity)
```

## Temperature

```{r temp-interf, dpi = 120}
interact_reserve_interf_fxn("OWC", param = temperature)
```
