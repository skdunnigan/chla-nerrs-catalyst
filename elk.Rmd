...
```{r isco, dpi = 120}
interact_reserve_isco_fxn("ELK")
```

## Tank Samples

```{r tank, dpi = 120}
interact_reserve_tank_fxn("ELK")
```
...
interact_reserve_interf_fxn("ELK", param = fdom)
```

## Turbidity

```{r turb-interf, dpi = 120}
interact_reserve_interf_fxn("ELK", param = turbidity)
```

## Temperature

```{r temp-interf, dpi = 120}
interact_reserve_interf_fxn("ELK", param = temperature)
```
