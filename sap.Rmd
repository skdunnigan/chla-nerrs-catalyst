...
```{r all-data}
reserve_all_fxn("SAP") + 
  ggpubr::stat_regline_equation(label.y = 30) +
...
```{r isco, dpi = 120}
interact_reserve_isco_fxn("SAP")
```

## Tank Samples

```{r tank, dpi = 120}
interact_reserve_tank_fxn("SAP")
```
...
interact_reserve_interf_fxn("SAP", param = fdom)
```

## Turbidity

```{r turb-interf, dpi = 120}
interact_reserve_interf_fxn("SAP", param = turbidity)
```

## Temperature

```{r temp-interf, dpi = 120}
interact_reserve_interf_fxn("SAP", param = temperature)
```
