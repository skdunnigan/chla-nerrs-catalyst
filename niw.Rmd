...
```{r isco, dpi = 120}
interact_reserve_isco_fxn("NIW")
```

## Tank Samples

```{r tank, dpi = 120}
interact_reserve_tank_fxn("NIW")
```
...
interact_reserve_interf_fxn("NIW", param = fdom)
```

## Turbidity

```{r turb-interf, dpi = 120}
interact_reserve_interf_fxn("NIW", param = turbidity)
```

## Temperature

```{r temp-interf, dpi = 120}
interact_reserve_interf_fxn("NIW", param = temperature)
```
