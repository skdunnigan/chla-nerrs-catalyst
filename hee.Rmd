...
```{r isco, dpi = 120}
interact_reserve_isco_fxn("HEE")
```

## Tank Samples

```{r tank, dpi = 120}
interact_reserve_tank_fxn("HEE")
```
...
interact_reserve_interf_fxn("HEE", param = fdom)
```

## Turbidity

```{r turb-interf, dpi = 120}
interact_reserve_interf_fxn("HEE", param = turbidity)
```

## Temperature

```{r temp-interf, dpi = 120}
interact_reserve_interf_fxn("HEE", param = temperature)
```
